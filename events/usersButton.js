  ...
  async execute(interaction) {
    ...
    try {
      ...
      if (!interaction.member.permissions.has('ADMINISTRATOR')) {
        return await interaction.followUp({ content: 'You do not have permission to manage users in this ticket.', ephemeral: true });
      }
      ...
      await interaction.followUp({ embeds: [userOptionsEmbed], components: [{ type: 1, components: [addUsersButton, removeUsersButton] }] });
