...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('points-add')
    .setDescription('Add points to a user\'s balance.')
  ...
  async execute(interaction) {
    ...
    try {
      ...
      await pointsModel.updateOne({ id: selectedUser.id }, { $inc: { balance: amountToAdd } });

      const successEmbed = new EmbedBuilder()
        .setColor('#00FF00')
        .setDescription(`${amountToAdd} points added to ${selectedUser.username}'s balance.`);
